# Description: This file contains the main code for the virtual whiteboard application.
...
# save
saveBtn = ColorRect(1000, 0, 100, 100, (0, 100, 255), "Save")

# input button
inputBtn = ColorRect(1200, 0, 100, 100, (255, 0, 255), "Input")
...
while True:
    ...
    if upFingers:
        ...
        if upFingers[1] and not whiteBoard.isOver(x, y):
            ...
            # input button
            if inputBtn.isOver(x, y) and not coolingCounter:
                coolingCounter = 10
                inputBtn.alpha = 0
                root = Tk()
    ...
    # put input button
    inputBtn.drawRect(frame)
    cv2.rectangle(frame, (inputBtn.x, inputBtn.y), (inputBtn.x + inputBtn.w, inputBtn.y + inputBtn.h), (255, 255, 255), 2)
